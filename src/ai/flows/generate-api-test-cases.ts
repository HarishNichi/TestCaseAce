...
const GenerateApiTestCasesOutputSchema = z.object({
  englishTestCases: z.string().describe('The generated API test cases in English.'),
  japaneseTestCases: z.string().describe('The generated API test cases in Japanese.'),
});
